...
We can now use some of our categorical variables, such as SES (Socio-economic status) and CDR (Clinical Dementia Rating) to find new correlations using neural networks for classification. 
